...
export default function StickyContactBar() {
  return (
    <div className="sticky-contact-bar" role="navigation" aria-label="Quick contact">
      <a className="sticky-contact-button sticky-call" href={`tel:${CALL_TEL}`}>
        <PhoneIcon /> Call
      </a>
      <a
        className="sticky-contact-button sticky-whatsapp"
